...
{
    [SerializeField] private float health = 30; // enemy health
    ...
    public void takeDamage(float damage)
    {
        ...
        print("Minotaur Health: " + this.health);
    ...
    {
        GetComponentInChildren<MinotaurDamageDealer>().BeginDealDmg();
    }

    public void EndDealDmg()
    {
        GetComponentInChildren<MinotaurDamageDealer>().EndDealDmg();
    }
    ...
    void Die()
    {
        ...
        Destroy(this.gameObject, 2);    // kills the game object after X seconds (set a timer to let the dying animation trigger)
        print("BOSS DEAD!");
    }
